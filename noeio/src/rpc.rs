...
#[cfg(unix)]
pub(crate) async fn incoming() -> Result<tokio_stream::wrappers::UnixListenerStream, Box<dyn std::error::Error>>
{
...
#[cfg(windows)]
pub(crate) async fn incoming() -> Result<noeio_common::named_pipe::NamedPipeStream, Box<dyn std::error::Error>>
{
